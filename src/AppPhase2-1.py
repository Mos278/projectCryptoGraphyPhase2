...
def main():
    ...
    cipher_text = ElgamalEncrypt(p=public_key.p, g=public_key.g, y=public_key.y, binary_file=binary_input_file)
    ...
    binary_cipher_text_read_from_file = FileInput.readBinaryFromFileHandlePostPadding(input_file_name=cipher_file_path,
                                                                                      block_size=bit_size)
    message = elgamalDecrypt(u=private_key.u, p=private_key.p, binary_cipher_text=binary_cipher_text_read_from_file)
